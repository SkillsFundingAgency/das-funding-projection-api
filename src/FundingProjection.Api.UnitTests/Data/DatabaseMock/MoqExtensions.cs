...
namespace SFA.DAS.FundingProjection.Api.UnitTests.Data.DatabaseMock;
...
public static class MoqExtensions
{
    ...
    public static IReturnsResult<IFundingProjectionDataContext> ReturnsDbSet<TEntity>(
        this ISetup<IFundingProjectionDataContext, DbSet<TEntity>> setupResult,
